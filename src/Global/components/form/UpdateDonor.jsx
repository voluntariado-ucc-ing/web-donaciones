...
class UpdateDonor extends Component {
    ...
    handleInputChange = (telNumber) => {
        this.props.handleChangeUpdateDonor(telNumber)
    };


    render() {
        //Constantes de names
        const { firstName, lastName, handleChange, email, emailConfirm, phone, handleChangeUpdateDonor } = this.props;
            ...
            <div className="donorDiv">
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        placeholder="Nombre"
                        name="firstName"
                        onChange={handleChangeUpdateDonor('firstName')}
                        value={firstName}
                        isInvalid={nameError}
                ...
                <Form.Group>
                    ...
                    <Form.Control
                        ...
                        name='lastName'
                        onChange={handleChangeUpdateDonor('lastName')}
                        value={lastName}
